...
public class UpdateReservationView extends Layout {
    ...
    public UpdateReservationView(Room room, String check_in_date, String check_out_date, int adult_numb, int child_numb, Reservation reservation) {
        ...
        this.tf_res_guess_name.setText(String.valueOf(this.reservation.getGuest_name()));
        this.tf_res_guess_mail.setText(String.valueOf(this.reservation.getGuess_mail()));
        this.tf_res_guess_tel_no.setText(this.reservation.getGuess_phone());
        this.tf_res_guess_id_no.setText(String.valueOf(this.reservation.getGuess_citizen_id()));
